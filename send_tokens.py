...
# }
    ...
    if connection_type == "indexer":
        ...
        # return an instance of the client for sending transactions
...
def send_tokens_algo( acl, sender_sk, txes):
    ...
    tx_ids = []
    # You might want to adjust the first/last valid rounds in the suggested_params
    ...
    #  Return a list of transaction id's
